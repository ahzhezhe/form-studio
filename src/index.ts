...
import { CustomConfig, QuestionType, ChoiceValue, ChoiceOnChange, Validator, Answers, Errors } from './Types';
...
export {
  ...
  CustomConfig, QuestionType, ChoiceValue, ChoiceOnChange, Validator, Answers, Errors,
  useTemplate
};
